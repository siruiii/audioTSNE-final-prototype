...
def process_json_data(data):
    ...
    points = [item['point'][0] for item in data]
    max_x = max(points)
    min_x = min(points)
    range_x = max_x - min_x
    radius = 150
...
input_file = '../1-mfcc-tsne/tsne_results1.json'  # Replace with your input file path
output_file = '_coordinates1.json'  # Replace with your output file path
