...
def process_json_data(data):
    ...
    points = [item['point'][0]*13 for item in data]
    max_x = max(points)
    min_x = min(points)
    range_x = max_x - min_x
    radius = 150
...
input_file = '../2-DBSCAN-KMEAN/peking25-5sec_tsne_results_with_clusters(DBSCAN with KMEAN).json'  # Replace with your input file path
